...
public final class FluidSampleSprec {
   ...
   * @see de.spreclib.api.main.FluidSampleTypeListProvider
   ...
   * @see de.spreclib.api.main.PrimaryContainerListProvider
   * @return FluidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.PreCentrifugationListProvider
   * @return FluidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.FirstCentrifugationListProvider
   * @return FluidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.SecondCentrifugationListProvider
   * @return FluidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.PostCentrifugationListProvider
   * @return FluidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.LongTermStorageListProvider
   * @return FluidSampleSprec Returns itself
   */
