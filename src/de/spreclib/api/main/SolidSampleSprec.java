...
public class SolidSampleSprec {
   ...
   * @see de.spreclib.api.main.SolidSampleTypeListProvider
   ...
   * @see de.spreclib.api.main.TypeOfCollectionListProvider
   * @return SolidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.WarmIschemiaTimeListProvider
   * @return SolidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.ColdIschemiaTimeListProvider
   * @return SolidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.FixationListProvider
   * @return SolidSampleSprec Returns itself
   */
   ...
   * @see de.spreclib.api.main.FixationTimeListProvider
   * @return SolidSampleSprec Returns itself
   */
